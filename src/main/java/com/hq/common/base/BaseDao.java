...
import com.hq.common.base.key.SnowflakeId;
import com.hq.common.base.utils.FieldUtil;
...
import static com.hq.common.base.key.Const.IdType.CUSTOM;
import static com.hq.common.base.key.Const.IdType.SNOW;
import static com.hq.common.base.key.Const.IdType.UUID;
...
import static com.hq.common.base.key.Const.Sql.DR_EQ;
import static com.hq.common.base.key.Const.Sql.INSERT_INTO;
import static com.hq.common.base.key.Const.Sql.LEFT_BRACKET;
import static com.hq.common.base.key.Const.Sql.REPLACE_INTO;
import static com.hq.common.base.key.Const.Sql.R_BRACKET;
import static com.hq.common.base.key.Const.Sql.R_VALUES;
import static com.hq.common.base.key.Const.Sql.UPDATE_BY;
import static com.hq.common.base.key.Const.Sql.UPDATE_TIME;
import static com.hq.common.base.utils.FieldUtil.autoId;
import static com.hq.common.base.utils.FieldUtil.byCondition;
import static com.hq.common.base.utils.FieldUtil.byConditionWithNull;
import static com.hq.common.base.utils.FieldUtil.byObject;
import static com.hq.common.base.utils.FieldUtil.byObjectWithNull;
import static com.hq.common.base.utils.FieldUtil.snowId;
import static com.hq.common.base.utils.FieldUtil.userId;
import static com.hq.common.base.utils.ReflectUtil.getValue;
import static com.hq.common.base.utils.ReflectUtil.hasDr;
import static com.hq.common.base.utils.ReflectUtil.idName;
import static com.hq.common.base.utils.ReflectUtil.idType;
import static com.hq.common.base.utils.ReflectUtil.tableName;
import static com.hq.common.base.utils.StringUtil.toLine;
import static com.hq.common.base.utils.StringUtil.toLowerCamel;
import static com.hq.common.base.utils.StringUtil.uuid;
...
public class BaseDao<T> extends BaseJdbc {
    ...
    public int delete(boolean show, final Object... ids) {
        String sql;
        if (hasDr) {
            sql = Sql.builder().update().table(table).set(DR_EQ).where().idIn(idName, ids).sql();
        } else {
    ...
    public <C extends BaseCondition> int delete(boolean show, final C c) {
        String sql;
        if (hasDr) {
            sql = Sql.builder().update().table(table).set(DR_EQ).where(c).sql();
        } else {
