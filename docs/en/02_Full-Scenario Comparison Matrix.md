...
> - To see the concrete implementation standard of the SQL-First paradigm, see **[03 SQL-First Persistence Development Paradigm Standard](https://gitee.com/gao_zhenzhong/simple-dao/blob/master/docs/en/03_SQL-First_Persistence_Development_Paradigm_Standard.md)**  
> - For Java implementation details and real-world cases, see **[04 SimpleDAO Technical Whitepaper](https://gitee.com/gao_zhenzhong/simple-dao/blob/master/docs/en/04_SimpleDAO_Technical_Whitepaper.md)**  
